  ...
  return (
     <nav className='flex items-center justify-between flex-wrap bg-teal-500 p-6'>
        ...
        <div className='block'>
          ...
          < i className="fa-solid fa-bars fa-spin fa-spin-reverse"></i>
          </button>
        ...
        { isVisible ? (<div className='w-full block flex-grow items-center'>
            ...
            <Button className='p-3 m-5 bg-teal-400 justify-center'>
                ...
                <Button className='p-3 m-5 bg-teal-400 justify-center'>
                    <div>
                       <Link to='/About' onClick={ clicked }className='flex place-item-center mt-4 lg:inline-block lg:mt-0
                       text-teal-200 hover:text-white mr-4'>About</Link>
                    </div>
                ...
                <Button className='p-3 m-5 bg-teal-400 justify-center'>
                    <div>
                       ...
                       text-teal-200 hover:text-white mr-4'>Dashboard</Link>
                    </div>
